...
public enum CourseErrorCode implements ErrorCode {
    ...
    CANNOT_SAVE_OWN_COURSE(HttpStatus.BAD_REQUEST, "CLIENT_ERROR_400_CANNOT_SAVE_OWN_COURSE", "본인이 만든 코스는 저장할 수 없습니다."),
    CANNOT_COPY_OWN_COURSE(HttpStatus.BAD_REQUEST, "CLIENT_ERROR_400_CANNOT_COPY_OWN_COURSE", "본인이 만든 코스는 복사할 수 없습니다."),
