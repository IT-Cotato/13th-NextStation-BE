...
public enum CourseErrorCode implements ErrorCode {
    ...
    STATION_NOT_FOUND(HttpStatus.NOT_FOUND, "CLIENT_ERROR_404_STATION_NOT_FOUND", "존재하지 않는 역입니다."),
    STATION_NOT_DRAWABLE(HttpStatus.BAD_REQUEST, "CLIENT_ERROR_400_STATION_NOT_DRAWABLE", "코스를 만들 수 없는 역입니다."),
