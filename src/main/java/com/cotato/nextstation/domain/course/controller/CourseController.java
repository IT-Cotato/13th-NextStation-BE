...
public class CourseController {
    ...
    public CommonResponse<CourseNameResponse> updateCourseName(
        ...
        return CommonResponse.success(courseCommandService.updateCourseName(principal.memberId(), courseId, request));
    }
    ...
    public CommonResponse<Void> updateCoursePlaceOrder(
        ...
        courseCommandService.updateCoursePlaceOrder(principal.memberId(), courseId, request);
