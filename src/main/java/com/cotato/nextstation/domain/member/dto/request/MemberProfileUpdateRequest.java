...
public record MemberProfileUpdateRequest(
        ...
        @Schema(description = "프로필 이미지 URL. presigned URL로 업로드 완료 후 받은 imageUrl을 그대로 전달. 빈 문자열(\"\")을 보내면 프로필 이미지를 제거한다. 필드 자체를 생략하면 변경하지 않는다", example = "https://bucket.s3.ap-northeast-2.amazonaws.com/images/uploads/profile/1/uuid.jpg")
