...
public enum AuthErrorCode implements ErrorCode {
    ...
    EMAIL_VERIFICATION_RATE_LIMIT_EXCEEDED(HttpStatus.TOO_MANY_REQUESTS, "CLIENT_ERROR_429_EMAIL_VERIFICATION_RATE_LIMIT_EXCEEDED", "인증코드 요청 횟수를 초과했습니다. 잠시 후 다시 시도해주세요."),
    ;
