...
@Schema(description = "카카오 신규 회원가입 완료(약관 동의) 요청")
public record KakaoSignupRequest(

        @Schema(description = "POST /kakao/login 응답으로 받은 kakaoSignupToken", example = "eyJhbGciOiJIUzI1NiJ9...")
        @NotBlank(message = "kakaoSignupToken은 필수입니다.")
